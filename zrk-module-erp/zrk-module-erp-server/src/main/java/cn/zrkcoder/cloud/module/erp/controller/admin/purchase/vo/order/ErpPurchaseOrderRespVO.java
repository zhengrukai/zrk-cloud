package cn.zrkcoder.cloud.module.erp.controller.admin.purchase.vo.order;
...
public class ErpPurchaseOrderRespVO {
    ...
    @Schema(description = "供应商名称", example = "zrk")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "附件地址", example = "https://www.zrkcoder.cn")
    @ExcelProperty("附件地址")
