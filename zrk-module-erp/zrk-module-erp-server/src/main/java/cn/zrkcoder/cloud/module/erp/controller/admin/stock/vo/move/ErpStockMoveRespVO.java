package cn.zrkcoder.cloud.module.erp.controller.admin.stock.vo.move;
...
import static cn.zrkcoder.cloud.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockMoveRespVO {
    ...
    @Schema(description = "附件 URL", example = "https://www.zrkcoder.cn/1.doc")
    private String fileUrl;

    @Schema(description = "创建人", example = "zrk")
    private String creator;
    @Schema(description = "创建人名称", example = "zrk")
