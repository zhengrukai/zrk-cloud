package cn.zrkcoder.cloud.module.ai.framework.ai.core.model;
...
import cn.zrkcoder.cloud.framework.common.util.spring.SpringUtils;
import cn.zrkcoder.cloud.module.ai.enums.model.AiPlatformEnum;
import cn.zrkcoder.cloud.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.zrkcoder.cloud.module.ai.framework.ai.config.ZrkAiProperties;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            ZrkAiProperties.Midjourney properties = SpringUtil.getBean(ZrkAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(ZrkAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        ZrkAiProperties.DouBao properties = new ZrkAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(ZrkAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        ZrkAiProperties.HunYuan properties = new ZrkAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(ZrkAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        ZrkAiProperties.SiliconFlow properties = new ZrkAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(ZrkAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        ZrkAiProperties.XingHuo properties = new ZrkAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(ZrkAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        ZrkAiProperties.BaiChuan properties = new ZrkAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(ZrkAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        ZrkAiProperties.Gemini properties = SpringUtil.getBean(ZrkAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        ZrkAiProperties.Grok properties = new ZrkAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
