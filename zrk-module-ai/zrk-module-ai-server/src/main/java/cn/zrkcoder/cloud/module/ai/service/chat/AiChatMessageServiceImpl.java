package cn.zrkcoder.cloud.module.ai.service.chat;
...
import cn.zrkcoder.cloud.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.zrkcoder.cloud.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.zrkcoder.cloud.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.zrkcoder.cloud.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.zrkcoder.cloud.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.zrkcoder.cloud.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.zrkcoder.cloud.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.zrkcoder.cloud.module.ai.dal.dataobject.model.AiChatRoleDO;
...
import cn.zrkcoder.cloud.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.zrkcoder.cloud.module.ai.enums.ErrorCodeConstants;
...
import static cn.zrkcoder.cloud.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.zrkcoder.cloud.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 zrk.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 zrk.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
