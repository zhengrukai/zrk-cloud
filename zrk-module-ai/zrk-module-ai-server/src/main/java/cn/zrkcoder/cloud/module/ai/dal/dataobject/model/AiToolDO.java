...
import cn.zrkcoder.cloud.module.ai.tool.function.DirectoryListToolFunction;
import cn.zrkcoder.cloud.module.ai.tool.function.WeatherQueryToolFunction;
...
public class AiToolDO extends BaseDO {
    ...
    /**
     * 状态
     * 枚举 {@link cn.zrkcoder.cloud.framework.common.enums.CommonStatusEnum}
     */
