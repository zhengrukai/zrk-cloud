package cn.zrkcoder.cloud.module.ai.controller.admin.music.vo;
...
public class AiMusicRespVO {
    ...
    @Schema(description = "图片地址", example = "https://www.zrkcoder.cn")
    private String imageUrl;

    @Schema(description = "音频地址", example = "https://www.zrkcoder.cn")
    private String audioUrl;

    @Schema(description = "视频地址", example = "https://www.zrkcoder.cn")
