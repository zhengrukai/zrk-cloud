...
import cn.zrkcoder.cloud.framework.datapermission.core.rpc.DataPermissionRequestInterceptor;
import cn.zrkcoder.cloud.framework.datapermission.core.rpc.DataPermissionRpcWebFilter;
import org.springframework.boot.autoconfigure.AutoConfiguration;
import org.springframework.boot.autoconfigure.condition.ConditionalOnClass;
import org.springframework.boot.web.servlet.FilterRegistrationBean;
import org.springframework.context.annotation.Bean;

import static cn.zrkcoder.cloud.framework.common.enums.WebFilterOrderEnum.TENANT_CONTEXT_FILTER;
/**
 * 数据权限针对 RPC 的自动配置类
 *
...
public class ZrkDataPermissionRpcAutoConfiguration {
