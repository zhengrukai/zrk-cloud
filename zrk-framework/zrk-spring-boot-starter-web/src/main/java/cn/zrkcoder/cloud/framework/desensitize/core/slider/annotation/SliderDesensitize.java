package cn.zrkcoder.cloud.framework.desensitize.core.slider.annotation;

import cn.zrkcoder.cloud.framework.desensitize.core.base.annotation.DesensitizeBy;
import cn.zrkcoder.cloud.framework.desensitize.core.slider.handler.DefaultDesensitizationHandler;
