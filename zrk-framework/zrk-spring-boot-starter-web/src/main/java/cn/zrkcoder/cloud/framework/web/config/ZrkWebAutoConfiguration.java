package cn.zrkcoder.cloud.framework.web.config;
...
import cn.zrkcoder.cloud.framework.web.core.filter.CacheRequestBodyFilter;
import cn.zrkcoder.cloud.framework.web.core.filter.DemoFilter;
import cn.zrkcoder.cloud.framework.web.core.handler.GlobalExceptionHandler;
import cn.zrkcoder.cloud.framework.web.core.handler.GlobalResponseBodyHandler;
...
@AutoConfiguration(beforeName = {
        "com.fhs.trans.config.TransServiceConfig" // cloud 独有：避免一键改包后，RestTemplate 初始化的冲突。
})
@EnableConfigurationProperties(WebProperties.class)
public class ZrkWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "zrk.demo", havingValue = "true")
