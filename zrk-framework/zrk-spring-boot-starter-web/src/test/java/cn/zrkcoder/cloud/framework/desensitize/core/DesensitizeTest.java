package cn.zrkcoder.cloud.framework.desensitize.core;
...
import cn.zrkcoder.cloud.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("zrk");
        desensitizeDemo.setBankCard("9988002866797031");
        desensitizeDemo.setCarLicense("浙A66666");
        ...
        desensitizeDemo.setRegex("你好，我是zrk");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("zrk");
        ...
        assertEquals("浙A6***6", d.getCarLicense());
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "zrk", replacer = "*")
