...
import cn.zrkcoder.cloud.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${zrk.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class ZrkMybatisAutoConfiguration {
