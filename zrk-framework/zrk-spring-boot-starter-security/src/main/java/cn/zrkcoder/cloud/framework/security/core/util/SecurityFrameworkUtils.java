package cn.zrkcoder.cloud.framework.security.core.util;
...
public class SecurityFrameworkUtils {
    ...
    public static String obtainAuthorization(HttpServletRequest request,
        ...
        final String authorizationBearerPrefix = AUTHORIZATION_BEARER + " ";
        int index = token.indexOf(authorizationBearerPrefix);
        return index >= 0 ? token.substring(index + authorizationBearerPrefix.length()).trim() : token;
    }
