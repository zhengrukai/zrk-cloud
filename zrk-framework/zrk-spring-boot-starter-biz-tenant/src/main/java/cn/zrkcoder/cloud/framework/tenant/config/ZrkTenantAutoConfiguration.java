...
import cn.zrkcoder.cloud.framework.redis.config.ZrkCacheProperties;
import cn.zrkcoder.cloud.framework.security.core.service.SecurityFrameworkService;
import cn.zrkcoder.cloud.framework.tenant.core.aop.TenantIgnore;
import cn.zrkcoder.cloud.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.zrkcoder.cloud.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.zrkcoder.cloud.framework.tenant.core.job.TenantJobAspect;
import cn.zrkcoder.cloud.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.zrkcoder.cloud.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.zrkcoder.cloud.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.zrkcoder.cloud.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.zrkcoder.cloud.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.zrkcoder.cloud.framework.tenant.core.service.TenantFrameworkService;
import cn.zrkcoder.cloud.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.zrkcoder.cloud.framework.tenant.core.web.TenantContextWebFilter;
import cn.zrkcoder.cloud.framework.tenant.core.web.TenantVisitContextInterceptor;
...
public class ZrkTenantAutoConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "cn.zrkcoder.cloud.framework.mq.redis.core.RedisMQTemplate")
