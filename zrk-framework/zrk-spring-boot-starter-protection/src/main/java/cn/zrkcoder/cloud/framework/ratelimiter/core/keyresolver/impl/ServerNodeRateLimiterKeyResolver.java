package cn.zrkcoder.cloud.framework.ratelimiter.core.keyresolver.impl;

import cn.hutool.crypto.SecureUtil;
import cn.hutool.system.SystemUtil;
import cn.zrkcoder.cloud.framework.common.util.string.StrUtils;
import cn.zrkcoder.cloud.framework.ratelimiter.core.annotation.RateLimiter;
import cn.zrkcoder.cloud.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import org.aspectj.lang.JoinPoint;

/**
 * Server 节点级别的限流 Key 解析器，使用方法名 + 方法参数 + Address+PID，组装成一个 Key
