package cn.zrkcoder.cloud.framework.common.biz.system.oauth2;

import cn.zrkcoder.cloud.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCheckRespDTO;
import cn.zrkcoder.cloud.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import cn.zrkcoder.cloud.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenRespDTO;
...
public interface OAuth2TokenCommonApi {
    ...
    @Parameter(name = "accessToken", description = "访问令牌", required = true, example = "lala")
    ...
    @Parameters({
            ...
            @Parameter(name = "clientId", description = "客户端编号", required = true, example = "zrk")
    })
