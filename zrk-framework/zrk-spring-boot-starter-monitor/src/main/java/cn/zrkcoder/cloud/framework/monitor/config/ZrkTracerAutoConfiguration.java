...
import cn.zrkcoder.cloud.framework.monitor.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "zrk.tracer", value = "enable", matchIfMissing = true)
public class ZrkTracerAutoConfiguration {

    // TODO skywalking 不兼容最新的 opentracing 版本。同时，opentracing 也停止了维护，尬住了！后续换 opentelemetry 即可！
//    @Bean
