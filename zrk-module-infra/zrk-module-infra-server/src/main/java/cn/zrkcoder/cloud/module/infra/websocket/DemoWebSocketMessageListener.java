package cn.zrkcoder.cloud.module.infra.websocket;
...
import cn.zrkcoder.cloud.framework.websocket.core.util.WebSocketFrameworkUtils;
import cn.zrkcoder.cloud.module.infra.websocket.message.DemoReceiveMessage;
import cn.zrkcoder.cloud.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 zrk.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
