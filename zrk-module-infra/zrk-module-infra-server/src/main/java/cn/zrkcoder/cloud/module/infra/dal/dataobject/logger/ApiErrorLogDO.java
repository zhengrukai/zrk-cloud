package cn.zrkcoder.cloud.module.infra.dal.dataobject.logger;
...
@NoArgsConstructor
@AllArgsConstructor
@KeySequence(value = "infra_api_error_log_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
public class ApiErrorLogDO extends BaseDO {
    ...
    /**
     * 处理用户编号
     * 关联 cn.zrkcoder.cloud.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
