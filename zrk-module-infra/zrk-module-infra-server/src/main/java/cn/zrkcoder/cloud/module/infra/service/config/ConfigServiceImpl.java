package cn.zrkcoder.cloud.module.infra.service.config;

import cn.zrkcoder.cloud.framework.common.pojo.PageResult;
import cn.zrkcoder.cloud.module.infra.controller.admin.config.vo.ConfigPageReqVO;
import cn.zrkcoder.cloud.module.infra.controller.admin.config.vo.ConfigSaveReqVO;
import cn.zrkcoder.cloud.module.infra.convert.config.ConfigConvert;
import cn.zrkcoder.cloud.module.infra.dal.dataobject.config.ConfigDO;
import cn.zrkcoder.cloud.module.infra.dal.mysql.config.ConfigMapper;
import cn.zrkcoder.cloud.module.infra.enums.config.ConfigTypeEnum;
