package cn.zrkcoder.cloud.module.infra.controller.admin.config;
...
import cn.zrkcoder.cloud.module.infra.enums.ErrorCodeConstants;
...
public class ConfigController {
    ...
    @Parameter(name = "key", description = "参数键", required = true, example = "zrk.biz.username")
