...
public class CodegenPreviewRespVO {
    ...
    @Schema(description = "文件路径", requiredMode = Schema.RequiredMode.REQUIRED, example = "java/cn/zrkcoder/cloud/adminserver/modules/system/controller/test/SysTestDemoController.java")
