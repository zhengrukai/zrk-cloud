package cn.zrkcoder.cloud.module.infra.controller.admin.codegen;
...
import cn.zrkcoder.cloud.module.infra.convert.codegen.CodegenConvert;
...
import cn.zrkcoder.cloud.module.infra.service.codegen.CodegenService;
...
import static cn.zrkcoder.cloud.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.zrkcoder.cloud.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "zrk"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "kk")
    })
