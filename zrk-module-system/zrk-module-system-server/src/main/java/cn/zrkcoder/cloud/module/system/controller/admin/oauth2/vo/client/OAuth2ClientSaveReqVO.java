package cn.zrkcoder.cloud.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientSaveReqVO {
    ...
    @Schema(description = "客户端编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "haha")
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "哈哈")
    @NotNull(message = "应用名不能为空")
    private String name;

    @Schema(description = "应用图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zrkcoder.cn/xx.png")
    ...
    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zrkcoder.cn")
    ...
    @Schema(description = "附加信息", example = "{zrk: true}")
