package cn.zrkcoder.cloud.module.system.controller.admin.oauth2;
...
import cn.zrkcoder.cloud.framework.common.util.http.HttpUtils;
import cn.zrkcoder.cloud.framework.common.util.json.JsonUtils;
import cn.zrkcoder.cloud.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import cn.zrkcoder.cloud.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import cn.zrkcoder.cloud.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import cn.zrkcoder.cloud.module.system.convert.oauth2.OAuth2OpenConvert;
import cn.zrkcoder.cloud.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import cn.zrkcoder.cloud.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import cn.zrkcoder.cloud.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import cn.zrkcoder.cloud.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import cn.zrkcoder.cloud.module.system.service.oauth2.OAuth2ApproveService;
import cn.zrkcoder.cloud.module.system.service.oauth2.OAuth2ClientService;
import cn.zrkcoder.cloud.module.system.service.oauth2.OAuth2GrantService;
import cn.zrkcoder.cloud.module.system.service.oauth2.OAuth2TokenService;
import cn.zrkcoder.cloud.module.system.util.oauth2.OAuth2Utils;
...
import static cn.zrkcoder.cloud.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
import static cn.zrkcoder.cloud.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
 ...
 * 虑到【本系统】暂时不想做的过于复杂，默认只有获取到 access token 之后，可以访问【本系统】管理后台的 /system-api/* 所有接口，除非手动添加 scope 控制。
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.zrkcoder.cn"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.zrkcoder.cn"),
