package cn.zrkcoder.cloud.module.system.controller.admin.user;
...
import cn.zrkcoder.cloud.module.system.controller.admin.user.vo.user.*;
import cn.zrkcoder.cloud.module.system.convert.user.UserConvert;
...
import cn.zrkcoder.cloud.module.system.enums.common.SexEnum;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("zrkai").deptId(1L).email("zrkai@zrkcoder.cn").mobile("15601691300")
                        .nickname("zrk").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("zrk").deptId(2L).email("zrk@zrkcoder.cn").mobile("15601701300")
                        .nickname("zrk").status(CommonStatusEnum.DISABLE.getStatus()).sex(SexEnum.FEMALE.getSex()).build()
        );
        // 输出
