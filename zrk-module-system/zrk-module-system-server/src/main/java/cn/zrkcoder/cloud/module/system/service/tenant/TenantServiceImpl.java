package cn.zrkcoder.cloud.module.system.service.tenant;
...
import cn.zrkcoder.cloud.framework.tenant.config.TenantProperties;
import cn.zrkcoder.cloud.framework.tenant.core.context.TenantContextHolder;
import cn.zrkcoder.cloud.framework.tenant.core.util.TenantUtils;
import cn.zrkcoder.cloud.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
...
import cn.zrkcoder.cloud.module.system.convert.tenant.TenantConvert;
...
import cn.zrkcoder.cloud.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.zrkcoder.cloud.module.system.dal.mysql.tenant.TenantMapper;
import cn.zrkcoder.cloud.module.system.enums.permission.RoleCodeEnum;
import cn.zrkcoder.cloud.module.system.enums.permission.RoleTypeEnum;
import cn.zrkcoder.cloud.module.system.service.permission.MenuService;
...
import cn.zrkcoder.cloud.module.system.service.tenant.handler.TenantInfoHandler;
import cn.zrkcoder.cloud.module.system.service.tenant.handler.TenantMenuHandler;
import cn.zrkcoder.cloud.module.system.service.user.AdminUserService;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 zrk.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
