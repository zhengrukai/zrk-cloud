package cn.zrkcoder.cloud.module.system.service.social;
...
import cn.zrkcoder.cloud.framework.common.util.cache.CacheUtils;
...
import cn.zrkcoder.cloud.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.zrkcoder.cloud.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.zrkcoder.cloud.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.zrkcoder.cloud.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.zrkcoder.cloud.module.system.controller.admin.social.vo.client.SocialClientPageReqVO;
import cn.zrkcoder.cloud.module.system.controller.admin.social.vo.client.SocialClientSaveReqVO;
import cn.zrkcoder.cloud.module.system.dal.dataobject.social.SocialClientDO;
import cn.zrkcoder.cloud.module.system.dal.mysql.social.SocialClientMapper;
import cn.zrkcoder.cloud.module.system.dal.redis.RedisKeyConstants;
import cn.zrkcoder.cloud.module.system.enums.social.SocialTypeEnum;
import cn.zrkcoder.cloud.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.zrkcoder.cloud.framework.common.util.collection.MapUtils.findAndThen;
import static cn.zrkcoder.cloud.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.zrkcoder.cloud.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${zrk.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${zrk.wxa-subscribe-message.miniprogram-state:formal}")
