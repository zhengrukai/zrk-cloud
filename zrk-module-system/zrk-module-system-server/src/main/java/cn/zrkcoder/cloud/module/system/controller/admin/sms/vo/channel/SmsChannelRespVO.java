package cn.zrkcoder.cloud.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelRespVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "zrk")
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "zrk")
    ...
    @Schema(description = "短信发送回调 URL", example = "https://www.zrkcoder.cn")
