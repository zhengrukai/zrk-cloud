...
import cn.zrkcoder.cloud.module.system.api.social.dto.*;
...
public interface SocialClientApi {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirectUri", description = "重定向 URL", example = "https://www.zrkcoder.cn", required = true)
    })
    ...
    @Parameters({
            @Parameter(name = "userType", description = "用户类型", example = "1", required = true),
            @Parameter(name = "url", description = "访问 URL", example = "https://www.zrkcoder.cn", required = true)
    })
    ...
    @Parameters({
            @Parameter(name = "userType", description = "用户类型", example = "1", required = true),
            @Parameter(name = "phoneCode", description = "手机授权码", example = "zrk11", required = true)
    })
