package cn.zrkcoder.cloud.module.system.api.user.dto;
...
public class AdminUserRespDTO implements VO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zrkcoder.cn/1.png")
